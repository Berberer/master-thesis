...
\input{content/chapter-2-theory}
\input{content/chapter-3-approach}
\input{content/chapter-4-implementation}
\input{content/chapter-5-evaluation}
...
\input{content/chapter-7-appendix}       % INCLUDE: appendix
%
{%
\setstretch{1.1}
...
\includepdf{content/declaration_signed.pdf}
\cleardoublepage
% \clearpage
% \newpage
% \mbox{}
