...
The dimensionality is reduced signigicantly and Bayesian optimization will be more effective.\newline
...
One example of a heuristic graph search based AutoML approach is called \textit{Mosaic}~\cite{Rakotoarison-Mosaic} and it utilizes such an MCTS and a multi-stage optimization method as well.
