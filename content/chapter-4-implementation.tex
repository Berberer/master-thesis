...
Between this two perspectives, the \texttt{OptimizationParameterDomain} can perform transformations between both formats.\newline
...
In this current reference implementation are five optimization algorithms implemented:
\begin{itemize}
    \item 
\end{itemize}
